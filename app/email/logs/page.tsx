      ...
      <div className="flex min-h-screen w-full overflow-x-hidden">
          ...
          <main className="flex-1 p-6">
            ...
            <div className="glass-card border-0 overflow-hidden">
              <div className="px-6 py-4 border-b border-gray-200 flex items-center justify-between">
                ...
                {dataSource === 'mock' && (
                  <div className="text-xs text-orange-600 bg-orange-50/80 px-2 py-1 rounded">
                    Demo Data
                  </div>
                )}
                {dataSource === 'database' && (
              ...
              {notice && (
                <div className={`px-6 py-3 border-b border-gray-200 ${
                  dataSource === 'mock' ? 'bg-blue-50/80' :
                  notice.includes('error') || notice.includes('Failed') ? 'bg-red-50/80' :
                  'bg-green-50/80'
                }`}>
                  <p className={`text-sm ${
              ...
              {loading ? (
                <div className="p-8 text-center">
                  <div className="animate-spin rounded-full h-8 w-8 border-b-2 mx-auto" style={{borderColor: '#3dbff2'}}></div>
                    ...
                    <tbody key={`tbody-${logs.length}-${filteredLogs.length}`} className="divide-y divide-gray-200">
                      {filteredLogs.map((log, index) => (
                        <tr key={log.id} className="hover:bg-gray-50/50 transition-colors">
                          ...
                          <td className="px-6 py-4">
                            <div>
                              <div className="font-medium text-gray-900">{log.metadata?.toEmail || 'Unknown'}</div>
        ...
        {showContentModal && selectedEmail && (
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
            <div className="glass-card border-0 w-full max-w-4xl max-h-[90vh] flex flex-col">
              ...
              <div className="flex-1 overflow-y-auto p-6">
                ...
                {selectedEmail.content && (
                  <div>
                    ...
                    {/* HTML Content */}
                    <div className="bg-white/50 border border-gray-200 rounded-lg">
                      <div className="p-4">
                        <iframe
                    ...
                    {selectedEmail.content.text && (
                      <div className="mt-4 bg-gray-50/80 p-4 rounded-lg">
